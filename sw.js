/* Service worker for index.html — keeps the app usable with no signal.
 *
 * Strategy per resource:
 *   app shell (index.html, vendor/*, manifest, icons)  cache-first, precached on install
 ...
 *
 * Bump VERSION whenever index.html or vendor files change so clients pick them up.
 */
'use strict';
