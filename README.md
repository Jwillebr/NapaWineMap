...
**Interactive map of every winery reviewed by [The Napa Wine Project](https://www.napawineproject.com/reviews/).**

Live app: **https://jwillebr.github.io/NapaWineMap/**

`index.html` is a self-contained page: Leaflet and its marker-cluster plugin are
...
Commit `data/wineries.json` when you're happy with it — that file plus `index.html`
...
each push to `main`, the map lives at:

```
https://jwillebr.github.io/NapaWineMap/
```
